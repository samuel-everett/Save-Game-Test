...
public class Data {
    ...
    // A constructor is used to create a Data object. This version of the method creates a Data object from a passed GameState object. 
    ...
    // A constructor is used to create a blank Data object. These will be values on a new save.  
    public Data () {
        position = new float[3];
        position[0] = 0;
        position[1] = 0;
